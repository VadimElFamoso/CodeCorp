<template>
  <div class="relative bg-secondary opacity-100 h-screen w-full">
    <div class="border-b-2 border-tertiary m-auto font-ethnocentric font-bold text-tertiary text-5xl py-16 w-10/12">
        ...
        <!--Card Container-->
        <div class="card_container flex justify-center gap-8 m-auto my-10 items-stretch text-center w-10/12 z-[100]">

            <!--Card-->
            <div class="relative card h-[80%] w-1/4 p-8">
            ...
            <div class="relative card h-[80%] w-1/4 p-8">
                ...
                <img @click="" class="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 h-auto w-10/12" src="../public/banner.svg" alt="">
