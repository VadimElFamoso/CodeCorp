...
<template>
  <div class="relative bg-secondary opacity-100 h-screen w-full">
    ...
    <div class="contact_container flex">
      ...
      <!--Contact image-->
      <div class="contact_picture bg-green-700 h-screen w-[40vw]">
        <img src="../public/dev.jpg" alt="contact" class="w-full object-cover h-screen">
      </div>

      <!--Contact form-->
      <div class="contact_form flex flex-col gap-4 h-auto justify-center w-[60vw] text-tertiary py-5">
        ...
        <form action="send_form.php" class="font-areaextended flex flex-col gap-10 ml-auto mr-auto w-10/12">
